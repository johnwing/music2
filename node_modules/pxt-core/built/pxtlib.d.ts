...
declare namespace pxt.BrowserUtils {
    ...
    function setCookieLang(langId: string, docs?: boolean): void;
}
...
declare namespace pxt.github {
    ...
    function toGithubDependencyPath(id: ParsedRepo): string;
    ...
    function lookupFile(commit: pxt.github.Commit, path: string): TreeEntry;
    function reconstructConfig(files: pxt.Map<string>, commit: pxt.github.Commit, tp: pxt.ProjectTemplate): PackageConfig;
}
declare namespace pxt {
...
declare namespace pxt.react {
    ...
    let getFieldEditorView: (fieldEditorId: string, value: string, options: any) => FieldEditorView;
}
...
declare namespace pxt.sprite {
    ...
    class Bitmap {
        ...
        constructor(width: number, height: number, x0?: number, y0?: number, buf?: Uint8Array);
